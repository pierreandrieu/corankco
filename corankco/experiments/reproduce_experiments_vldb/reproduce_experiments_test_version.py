from corankco.experiments.bench import BenchPartitioningScoringScheme, BenchTime, BenchScalabilityScoringScheme
from corankco.experiments.experimentOrphanet import ExperimentOrphanet
from corankco.experiments.marksExperiment import MarksExperiment
...
if len(sys.argv) == 1:
    display_manual()
    run_experiment_students_vldb(False, False)

...
from corankco.algorithms.exact.exactalgorithmcplexforpaperoptim2 import ExactAlgorithmCplexForPaperOptim2
...
class TestAlgos(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.my_algs.extend([ExactAlgorithmCplex(optimize=True), ExactAlgorithmCplex(optimize=False),
                             ParCons(), ExactAlgorithmGeneric(), ExactAlgorithmCplexForPaperOptim2(),
                             ExactAlgorithmCplexForPaperOptim1(), ExactAlgorithm()])
